...
import { updaterentcondopost, Uploadimage } from '../../Firebase/firebase.utils';
...
const Editrentroom = (props) => {
  ...
  const [postcredential, setpostcredential] = useState({
    ...
    deposit: postdata?.monthlyfee ? postdata?.monthlyfee : '',
    sex: postdata?.sex ? postdata?.sex : '',
    utility: postdata?.utility ? postdata?.utility : '',
    funished: postdata?.funished ? postdata?.funished : '',
    monthlyfee: postdata?.monthlyfee ? postdata?.monthlyfee : '',
    roomtype: postdata?.postdata ? postdata?.postdata : '',
